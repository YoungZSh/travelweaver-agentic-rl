"""OpenAI-compatible chat-completion clients used by rollout runners."""
...
class OpenAICompatibleConfig:
    ...
    def completion_options(self) -> dict[str, Any]:
        """Return request fields shared by compatible providers."""
    ...
    def from_env(
        ...
        *,
        ...
        """Load a generic endpoint from ``<PREFIX>_*`` process variables."""
